...
import { LayoutDashboard, LineChart, Settings, Activity, FileText, Lock, Wallet, Layers, ShieldCheck, Mail, Hexagon, History } from 'lucide-react';
        ...
        {menuItems.map((item) => {
            ...
            return (
                <button
                    ...
                    className={`flex items-center justify-center lg:justify-start px-4 py-3 rounded-lg transition-colors group relative ${
                        isActive
