  ...
  return (
    <div className="flex flex-col gap-6 animate-fade-in pb-10">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
            ...
            <div className="bg-surface border border-card-border rounded-xl p-5 shadow-lg relative overflow-hidden">
                <div className="text-xs uppercase font-bold text-gray-500 mb-1">PnL Não Realizado</div>
                ...
                <div className="absolute top-4 right-4 p-2 bg-blue-500/10 rounded-lg text-blue-500"><Activity size={16} /></div>
            </div>
            ...
            <div className="bg-surface border border-card-border rounded-xl p-5 shadow-lg relative overflow-hidden">
                <div className="text-xs uppercase font-bold text-gray-500 mb-1">Win Rate</div>
                <div className="text-3xl font-mono font-bold text-white">94%</div>
                <div className="absolute top-4 right-4 p-2 bg-purple-500/10 rounded-lg text-purple-500"><PieChart size={16} /></div>
            </div>
      </div>
