  ...
  return (
    <div className="flex flex-col gap-6 animate-fade-in pb-20 max-w-[1400px] mx-auto w-full">
      ...
      {results ? (
        ...
        <div className="flex flex-col items-center justify-center py-20 bg-surface border border-card-border rounded-2xl shadow-xl opacity-50">
           <BarChart3 size={64} className="mb-4 text-gray-700" />
           <p className="text-gray-500 font-bold uppercase tracking-widest text-xs">Aguardando Parâmetros de Simulação</p>
        </div>
      )}
    </div>
  );
